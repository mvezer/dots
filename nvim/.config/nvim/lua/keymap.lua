...
vim.keymap.set("n", "<leader>gn", "mN", { silent = true })
vim.keymap.set("n", "<leader>ge", "mE", { silent = true })
vim.keymap.set("n", "<leader>gi", "mI", { silent = true })
vim.keymap.set("n", "<leader>go", "mO", { silent = true })
vim.keymap.set("n", "<tab>n", "'N", { silent = true })
vim.keymap.set("n", "<tab>e", "'E", { silent = true })
vim.keymap.set("n", "<tab>i", "'I", { silent = true })
vim.keymap.set("n", "<tab>o", "'o", { silent = true })
